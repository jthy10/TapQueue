...
public static class PrinterInstaller
{
    ...
    public static async Task<(bool Success, string Output)> EnsureInstalledAsync(string name, Uri ippUrl, bool reinstall)
    {
        ...
        start.Environment["TQ_PRINTER_NAME"] = name;
        start.Environment["TQ_PRINTER_URL"] = ippUrl.ToString();
        start.Environment["TQ_REINSTALL"] = reinstall ? "1" : "0";
        ...
        catch (OperationCanceledException)
        {
            ...
            return (false, "Timed out adding the printer.");
        }
