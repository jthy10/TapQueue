...
const filters = [["", "Everything"], ["job", "Jobs"], ["tap", "Taps"], ["signin", "Sign-ins"], ["printer", "Printers"], ["crash", "Crashes"], ["directory", "Active Directory"], ["admin", "Admin changes"]];
const icons = { admin: "admins", job: "jobs", tap: "cards", signin: "workstations", crash: "alert", printer: "printers", directory: "directory" };
...
export async function render(root, ctx) {
  ...
  root.append(pageHead("Activity", "Everything that happened: prints and releases, badge taps, sign-ins, printer problems, Active Directory syncs and admin changes. Kept for 90 days."),
